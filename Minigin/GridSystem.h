...
namespace Pengin
{
	...
	public:
		...
		[[nodiscard]] std::pair<uint16_t, uint16_t> GetCellCoords(EntityId gridId, const glm::vec3& position) const noexcept;
		...
		[[nodiscard]] bool IsPosInGridArea(const glm::vec3& position, EntityId gridId) const noexcept;
